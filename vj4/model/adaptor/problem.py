...
SETTING_SOURCE_BOOK1 = 3
SETTING_SOURCE_BOOK2 = 4
SETTING_SOURCE_BOOK3 = 5
SETTING_SOURCE_BOOK4 = 6
SETTING_SOURCE_BOOK5 = 7
SETTING_SOURCE_BOOK6 = 8
SETTING_SOURCE_BOOK7 = 9
SETTING_SOURCE_BOOK8 = 10
SETTING_SOURCE_BOOK9 = 11

SETTING_SOURCE_RANGE = collections.OrderedDict([
  (SETTING_SOURCE_UNKNOWN, 'Unknown'),
  (SETTING_SOURCE_ORIGIN, 'Origin'),
  (SETTING_SOURCE_BOOK1, 'YBT'),
  (SETTING_SOURCE_BOOK2, 'KKT'),
  (SETTING_SOURCE_BOOK3, 'JinJieZhiNan-Li Yudong'),
  (SETTING_SOURCE_BOOK4, 'RuMenJingDian-Liu Rujia'),
  (SETTING_SOURCE_BOOK5, 'CCF-RuMen'),
  (SETTING_SOURCE_BOOK6, 'CCF-JiChu'),
  (SETTING_SOURCE_BOOK7, 'CCF-TiGao'),
  (SETTING_SOURCE_BOOK8, 'Lan Qiao Cup'),
  (SETTING_SOURCE_BOOK9, 'KaoYanZhenTi'),
  (SETTING_SOURCE_OTHER, 'Other')
])
...
SETTING_QUALITY_UNKNOWN = 0
SETTING_QUALITY_BAD = 1
SETTING_QUALITY_AVERAGE = 2
SETTING_QUALITY_GOOD = 3
SETTING_QUALITY_VERY_GOOD = 4
SETTING_QUALITY_EXCELLENT = 5

SETTING_PROBLEM_QUALITY_RANGE = collections.OrderedDict([
  (SETTING_QUALITY_UNKNOWN, 'Unknown'),
  (SETTING_QUALITY_BAD, 'bad'),
  (SETTING_QUALITY_AVERAGE, 'average'),
  (SETTING_QUALITY_GOOD, 'good'),
  (SETTING_QUALITY_VERY_GOOD, 'very good'),
